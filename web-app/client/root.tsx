...
export function Layout({ children }: { children: ReactNode }): ReactElement {
  ...
  useEffect((): void => {
    ...
    if(isAuthenticated && location.pathname === '/') {  // ログイン済の場合は `/library` に移動する
  ...
  return (
    <html lang="ja">
      <head>
        <meta charSet="UTF-8" />
        <title>Neo's Music Library</title>
        ...
        <meta property="og:title" content="Neo's Music Library" />
        <meta property="og:description" content="Neo's Music Library" />
        <meta property="og:url" content="https://music-library.neos21.workers.dev" />
        <meta property="og:image" content="https://music-library.neos21.workers.dev/icon-512.png" />
        <meta property="og:locale" content="ja_JP" />
        
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:title" content="Neo's Music Library" />
        <meta property="twitter:description" content="Neo's Music Library" />
        <meta property="twitter:url" content="https://music-library.neos21.workers.dev" />
        <meta property="twitter:image" content="https://music-library.neos21.workers.dev/icon-512.png" />
...
export function ErrorBoundary({ error }: Route.ErrorBoundaryProps): ReactElement {
  ...
  return (
    <main className="m-4 alert alert-vertical alert-soft alert-error">
      <h1>{title}</h1>
      <p>{text}</p>
